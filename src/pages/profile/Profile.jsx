...
const Profile = () => {
  ...
  return (
    <div className={`${styles.containerHeight} bg-[#0F1014] p-3`}>
      ...
      <h1 className="text-2xl text-gray-300 font-bold mb-4">Profile</h1>
      {isPopupOpen ? (
        <div
          ref={popupRef}
          className="fixed p-5 rounded-2xl top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 z-50 shadow-lg"
        >
          <button
